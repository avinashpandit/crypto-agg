...
/***************************************************/
func CreatePhemex(config *exchange.Config) *Phemex {
	once.Do(func() {
		instance = &Phemex{
			ID:      DEFAULT_ID,
			Name:    "Phemex",
			Website: "https://api.phemex.com",
...
func (e *Phemex) GetID() int {
	return e.ID
}

func (e *Phemex) GetName() exchange.ExchangeName {
	return exchange.PHEMEX
}

func (e *Phemex) GetBalance(coin *coin.Coin) float64 {
...
func (e *Phemex) GetTradingWebURL(pair *pair.Pair) string {
	return fmt.Sprintf("https://www.Phemex.com/trade.html?symbol=%s_%s", e.GetSymbolByCoin(pair.Target), e.GetSymbolByCoin(pair.Base))
}

/*************** Coins on the Exchanges ***************/
func (e *Phemex) GetCoinConstraint(coin *coin.Coin) *exchange.CoinConstraint {
...
func (e *Phemex) SetCoinConstraint(coinConstraint *exchange.CoinConstraint) {
	coinConstraintMap.Set(fmt.Sprintf("%d", coinConstraint.CoinID), coinConstraint)
}

func (e *Phemex) GetCoins() []*coin.Coin {
	coinList := []*coin.Coin{}
	keySort := []int{}
...
func (e *Phemex) GetSymbolByCoin(coin *coin.Coin) string {
...
func (e *Phemex) GetCoinBySymbol(symbol string) *coin.Coin {
...
func (e *Phemex) DeleteCoin(coin *coin.Coin) {
	coinConstraintMap.Remove(fmt.Sprintf("%d", coin.ID))
}

/*************** Pairs on the Exchanges ***************/
func (e *Phemex) GetPairConstraint(pair *pair.Pair) *exchange.PairConstraint {
	if pair == nil {
		return nil
	}
...
func (e *Phemex) SetPairConstraint(pairConstraint *exchange.PairConstraint) {
	pairConstraintMap.Set(fmt.Sprintf("%d", pairConstraint.PairID), pairConstraint)
}

func (e *Phemex) GetPairs() []*pair.Pair {
	pairList := []*pair.Pair{}
	keySort := []int{}
...
func (e *Phemex) GetPairBySymbol(symbol string) *pair.Pair {
...
func (e *Phemex) GetSymbolByPair(pair *pair.Pair) string {
...
func (e *Phemex) HasPair(pair *pair.Pair) bool {
	return pairConstraintMap.Has(fmt.Sprintf("%d", pair.ID))
}

func (e *Phemex) DeletePair(pair *pair.Pair) {
	pairConstraintMap.Remove(fmt.Sprintf("%d", pair.ID))
}

/**************** Exchange Constraint ****************/
func (e *Phemex) GetConstraintFetchMethod(pair *pair.Pair) *exchange.ConstrainFetchMethod {
...
/**************** Coin Constraint ****************/
func (e *Phemex) GetTxFee(coin *coin.Coin) float64 {
...
func (e *Phemex) CanWithdraw(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Phemex) CanDeposit(coin *coin.Coin) bool {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return false
	}
...
func (e *Phemex) GetConfirmation(coin *coin.Coin) int {
	coinConstraint := e.GetCoinConstraint(coin)
	if coinConstraint == nil {
		return 0
	}
...
/**************** Pair Constraint ****************/
func (e *Phemex) GetFee(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Phemex) GetLotSize(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
...
func (e *Phemex) GetPriceFilter(pair *pair.Pair) float64 {
	pairConstraint := e.GetPairConstraint(pair)
	if pairConstraint == nil {
		return 0.0
	}
